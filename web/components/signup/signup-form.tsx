  ...
  return (
    <div className="relative z-10 w-full max-w-sm p-4 sm:p-8">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            ...
            <Button
              ...
              className="h-10 px-3 text-xs font-medium bg-blue-600 hover:bg-blue-500 text-white transition-all active:scale-[0.98] disabled:opacity-50 shrink-0"
            >
        ...
        {/* Sign Up Button */}
        <Button className="w-full mt-2 h-10 text-sm font-medium bg-blue-600 hover:bg-blue-500 text-white transition-all hover:scale-[1.02] hover:shadow-[0_0_20px_rgba(37,99,235,0.3)] border-none">
          Sign up
        </Button>
